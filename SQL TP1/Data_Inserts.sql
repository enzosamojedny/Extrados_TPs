--CREATE DATABASE ExtradosDB
--USE ExtradosDB

CREATE TABLE locaciones(
ID_LOCACION smallint PRIMARY KEY not null,
...
ID_EMPLEADO tinyint PRIMARY KEY not null,
NOMBRE varchar(20),
APELLIDO varchar(20),
EMAIL varchar(30),
TELEFONO varchar(50),
FECHA_EN varchar(20),
ID_TRABAJO varchar(20),
...
INSERT INTO locaciones (ID_LOCACION,DIRECCION,CODIGO_POSTAL,CIUDAD,ESTADO_PROVINCIA,ID_PAIS) VALUES (1100,'93091 Calle della Testa','10934','Venice',NULL,'IT')
...
INSERT INTO locaciones (ID_LOCACION,DIRECCION,CODIGO_POSTAL,CIUDAD,ESTADO_PROVINCIA,ID_PAIS) VALUES (2500,'Magdalen Centre, The Oxford Science Park','OX9 9ZB','Oxford','Oxford','UK')
...
--insert empleados
INSERT INTO empleados (ID_EMPLEADO, NOMBRE, APELLIDO, EMAIL, TELEFONO, FECHA_EN, ID_TRABAJO, SALARIO, COMISION, ID_MANAGER, ID_DEPARTAMENTO) VALUES 
...
(136, 'Hazel', 'Philtanker', 'HPHILTAN', '650.127.1634', '2008-05-11', 'ST_CLERK', 2100.00, 0.00, 122, 50),
...
--insert departamento
INSERT INTO departamentos (ID_DEPARTAMENTO, NOMBRE, ID_MANAGER, ID_LOCACION) VALUES
